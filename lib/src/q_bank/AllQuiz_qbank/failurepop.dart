...
class PaymentDialogFailure extends StatefulWidget {


  const PaymentDialogFailure( {Key key, }): super(key: key);

  @override
  _PaymentDialogFailureState createState() => _PaymentDialogFailureState();
}

class _PaymentDialogFailureState extends State<PaymentDialogFailure> {
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.center,
            children: [
              Container(
                ...
                child: Text("Payment UnSuccessfull",style: TextStyle(color: Colors.grey.shade400,
              ...
              Container(
                ...
                child: Text("You Can't Attend Exam",style: TextStyle(color: Colors.grey.shade400,
                    fontSize: 15.0,fontWeight: FontWeight.w500,letterSpacing: 0.2),),
              ),
              sizebox_height_5,
              Container(
                ...
                child: ElevatedButton(
                  onPressed: (){
                    ...
                    child: Text("Proceed Again",style: TextStyle(color: Colors.grey.shade400,
                        fontSize: 15.0,fontWeight: FontWeight.w500,letterSpacing: 0.2),),),
              ),
