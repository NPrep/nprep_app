...
//
//     videoDetailcontroller.Hivevideolisner();
//     videoDetailcontroller.HivevideoPlayer(videodatatasks[widget.index].videopath, videodatatasks[widget.index].videokey);
//     setState(() {});
//
...
//                          BetterPlayer(
//                            controller:
//                            videoDetailcontroller.HivebetterPlayerController,
//                            key: videoDetailcontroller.HivebetterPlayerKey,
//                          ),
//                          Positioned(
...
//                           aspectRatio: 16 / 9,
//                           child: BetterPlayer(
//                             controller:videoDetailcontroller.HivebetterPlayerController,
//                             key: videoDetailcontroller.HivebetterPlayerKey,
//                           ),
//                         ),
//                       ),
...
//                                         onTap: (){
//                                           videoDetailcontroller.HivebetterPlayerController.seekTo(Duration(
...
//                                                         0.10,
//                                                     child:
//                                                     videoDetailcontroller.Savevideo_showColorLabels(Tablistdata['time'].toString()
...
//                                                     style: TextStyle(
//                                                         color:videoDetailcontroller.Savevideo_showColorLabels(Tablistdata['time'].toString(),
