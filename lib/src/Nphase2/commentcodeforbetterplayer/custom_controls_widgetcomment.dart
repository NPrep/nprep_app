...
//                                 InkWell(
//                                   onTap: () {
//                                     if(videoDetailcontroller.VideoLoadingloader.value!=true){
//                                       setState(() {
//                                         if (widget.controller.isPlaying())
...
//
//                                   },
//                                   child: videoDetailcontroller.VideoLoadingloader.value==true?CircularProgressIndicator():
//                                   Container(
//                                     height: 50,
//                                     width: 80,
//
...
//                         ),
//                         SizedBox(height: 10,),
//                         videoDetailcontroller.isInSmallMode==false?  Column(
//                           children: [
//                             Padding(
...
//                                       SizedBox(width: 10,),
//                                       Text("${widget.controller.videoPlayerController.value.position.toString().split(".")[0]} / ${widget.controller.videoPlayerController.value.duration.toString().split(".")[0]}",style: TextStyle(color: Colors.white),),
//                                     ],
//                                   ),
//
...
//                         color: Colors.black.withOpacity(0.5),child:Icon(
//                            Icons.play_arrow,
...
//                       ),
//                     ):Container(),
//                     videoDetailcontroller.isInSmallMode==false? videoDetailcontroller.VideoLoadingBeforeloader.value!=true?   Positioned(
//                       right: 10,
//                       top: 10,
//                       child: GestureDetector(
//                           onTap: (){
...
//       progress: Duration(milliseconds: widget.controller.videoPlayerController.value.position.inMilliseconds),
//       buffered: Duration(milliseconds: widget.controller.videoPlayerController.value.buffered.length),
//       total: Duration(milliseconds: widget.controller.videoPlayerController.value.duration.inMilliseconds),
//       onSeek: (duration) {
...
//                 title: Text('0.5x'),
//                 onTap: () {
//                   widget.controller.setSpeed(0.5); // Set playback speed
