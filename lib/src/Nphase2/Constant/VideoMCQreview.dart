...
class VideoMCQReviewPage extends StatefulWidget {
  final bool skip;
  var exam_Ids;
  var pageId;
  VideoMCQReviewPage({Key key, this.skip,this.exam_Ids,this.pageId});

  @override
  State<VideoMCQReviewPage> createState() => _VideoMCQReviewPageState();
}

class _VideoMCQReviewPageState extends State<VideoMCQReviewPage> {
  var get_testUrl ;
