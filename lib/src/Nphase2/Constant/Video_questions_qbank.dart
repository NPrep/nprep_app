...
import '../../q_bank/new_questionbank/ReportissueScreen.dart';
                              ...
                              children: [
                                  ...
                                  get_data['attachment'].toString() == "null"
                                    ...
                                    Container(
                                      ...
                                      child:  InteractiveViewer(
                                        child: Image.network(
                                          getQuestionContro.getQuestionList[0]['questions'][getQuestionContro.quecounter.value - 1]['attachment'].toString(),
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        GestureDetector(
                                            ...
                                            child: Text('Have any query?',style: TextStyle(color: primary),)),
                                      ],
                                    ),
                                  ),
                                  SizedBox(height: 5),
                      ...
                      getQuestionContro.getQuestionList[0]['questions'][getQuestionContro.quecounter.value ]['is_attempt'] ==
                        ...
                        onTap: () async {
                          ...
                          if ((getQuestionContro .getQuestionList[0]['questions'].length-1) !=getQuestionContro.quecounter.value) {
                            ...
                            //   context,
                            //   MaterialPageRoute(builder: (context) => ReviewPage(pagestatus: widget.pagestatus,
                            //       exam_Ids: examD.toString())),
                            //   ModalRoute.withName('Foo'),
                            // );
                            Get.off(
                                ReviewPage(pagestatus: widget.pagestatus,
                                        exam_Ids: examD.toString())
                            );
                            // Navigator.push(
                            //     context,
                            //     MaterialPageRoute(
                            //         builder: (context) => ReviewPage(pagestatus: widget.pagestatus,
                            //             exam_Ids: examD.toString())
                            //     )
                            // );
                          }
