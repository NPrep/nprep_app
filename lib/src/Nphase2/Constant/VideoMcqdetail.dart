...
import 'Video_questions_qbank.dart';

class VideoMcqDetails extends StatefulWidget {
  final title;
  final header;
  final examid ;
  final checkstatus;
  ...
  @override
  State<VideoMcqDetails> createState() => _VideoMcqDetailsState();
}

class _VideoMcqDetailsState extends State<VideoMcqDetails> {
  bool isReview = true;
                        ...
                        if (widget.checkstatus != 3) {
                          ...
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                  ...
                                  builder: (context) => Videoquestionbank_new(
                      ...
                      onTap: () {
                        ...
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                ...
                                builder: (context) => Videoquestionbank_new(reattempt:
